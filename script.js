const words = [
    ...
    { word: "CLEANSE", pronunciation: "klenz", definition: "To make something completely clean", french: "Rendre quelque chose complètement propre." },
    ...
    { word: "FORSAKE", pronunciation: "forseik", definition: "To leave someone for ever, especially when they need you.", french: "Abandonner dans le sens de délaisser une personne" },
    ...
    { word: "LIKENESS", pronunciation: "LAInes", definition: "The fact of being similar in appearance.", french: "Ressemblance." },
    ...
    { word: "PAGAN", pronunciation: "PEIgan", definition: "Belonging or relating to a religion that worships many gods, especially one that existed before the main world religions", french: "Appartenir ou se rapporter à une religion qui vénère de nombreux dieux, en particulier une religion qui existait avant les principales religions du monde." },
